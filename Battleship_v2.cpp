...
const int MAXSHPS = 5; //Maximum amount of randomly generated ships
//Function Prototypes
void getCrds(char &cCrds, char &rCrds); //Gets coordinates from player
bool duplHit(char, char, char[][MAXSHPS],int sze); //Returns true if player coordinate matches that of an already sunk ship
